...
- **Live Coach ASP:** https://kajota-concierge-agent.onrender.com/ ·
  discovery: https://kajota-concierge-agent.onrender.com/coach/premium
  (returns a 402 with an x402 price tag — proof the paywall is live)
- **Live Mesh SKILL:** https://kajota-mesh-skill.onrender.com/healthz
