 ...
 *     (consolidated hub; previously standalone https://kajota-concierge-agent.onrender.com)
...
export const CONCIERGE_AGENT_BASE_URL =
  // consolidated hub route; previously 'https://kajota-concierge-agent.onrender.com'
